...
#define	USBIN		PINB	/* input port for USB bits */
#define	USBDDR		DDRB	/* data direction for USB bits */
 ...
 */
#define	USB_CFG_VENDOR_NAME		'a', 'g', 's', 'm', '.', 's', 'f', '.', 'n', 'e', 't'
 ...
 */
#define	USB_CFG_DEVICE_NAME		'U', 'S', 'B', ' ', 'S', 'm','a','r','t',' ','C','a','r','d',' ','R','e','a','d','e','r'
